...
const Header: React.FC = () => {
    ...
    return (
        <header className="sticky top-0 z-50 bg-white/70 dark:bg-gray-900/60 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-700/50 shadow-sm w-screen overflow-x-hidden">
